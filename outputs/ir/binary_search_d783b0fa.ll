; ModuleID = 'D:\cd_final\cross-lang-code-detector-master\outputs\uploads\binary_search.c'
source_filename = "D:\\cd_final\\cross-lang-code-detector-master\\outputs\\uploads\\binary_search.c"
...
$"??_C@_0BL@NHFMGNCM@Element?5found?5at?5index?5?$CFd?6?$AA@" = comdat any

@"??_C@_0BL@NHFMGNCM@Element?5found?5at?5index?5?$CFd?6?$AA@" = linkonce_odr dso_local unnamed_addr constant [27 x i8] c"Element found at index %d\0A\00", comdat, align 1
@__local_stdio_printf_options._OptionsStorage = internal global i64 0, align 8
@str = private unnamed_addr constant [18 x i8] c"Element not found\00", align 1
...
while.body.i:                                     ; preds = %cleanup.i, %entry
  %right.027.i = phi i32 [ %right.1.i, %cleanup.i ], [ 9, %entry ]
...
if.then:                                          ; preds = %while.body.i
  %call1 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @"??_C@_0BL@NHFMGNCM@Element?5found?5at?5index?5?$CFd?6?$AA@", i32 noundef 6)
  br label %if.end
...
!1 = !DIFile(filename: "D:\\cd_final\\cross-lang-code-detector-master\\outputs\\uploads\\binary_search.c", directory: "D:\\cd_final\\cross-lang-code-detector-master")
