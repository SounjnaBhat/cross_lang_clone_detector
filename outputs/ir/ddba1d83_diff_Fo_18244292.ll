...
$_QQclX459bc2497244b017cd45501dcf710568 = comdat any

@_QFEarr = internal global [100 x i32] zeroinitializer
@_QQclX459bc2497244b017cd45501dcf710568 = linkonce constant [59 x i8] c"D:\\cd\\project\\project\\outputs\\uploads\\ddba1d83_diff_Fo.f90\00", comdat

; Function Attrs: memory(readwrite, target_mem0: none, target_mem1: none)
define void @_QQmain() local_unnamed_addr #0 {
  %1 = alloca i32, align 4
  %2 = tail call ptr @_FortranAioBeginExternalListInput(i32 5, ptr nonnull @_QQclX459bc2497244b017cd45501dcf710568, i32 6) #4
...
.lr.ph:                                           ; preds = %0, %.lr.ph
  ...
  %9 = call ptr @_FortranAioBeginExternalListInput(i32 5, ptr nonnull @_QQclX459bc2497244b017cd45501dcf710568, i32 9) #4
...
._crit_edge14:                                    ; preds = %.lr.ph13, %middle.block, %._crit_edge.thread, %._crit_edge
  ...
  %28 = call ptr @_FortranAioBeginExternalListOutput(i32 6, ptr nonnull @_QQclX459bc2497244b017cd45501dcf710568, i32 20) #4
