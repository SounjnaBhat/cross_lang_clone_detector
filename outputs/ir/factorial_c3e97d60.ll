; ModuleID = 'D:\cd_final\cross-lang-code-detector-master\testcases\benchmark\factorial.c'
source_filename = "D:\\cd_final\\cross-lang-code-detector-master\\testcases\\benchmark\\factorial.c"
...
for.body.preheader8:                              ; preds = %for.body.preheader, %middle.block
  %i.06.ph = phi i32 [ 1, %for.body.preheader ], [ %0, %middle.block ]
  %val.05.ph = phi i32 [ 1, %for.body.preheader ], [ %4, %middle.block ]
  br label %for.body

for.cond.cleanup:                                 ; preds = %for.body, %middle.block, %entry
  %val.0.lcssa = phi i32 [ 1, %entry ], [ %4, %middle.block ], [ %mul, %for.body ]
  ret i32 %val.0.lcssa

for.body:                                         ; preds = %for.body.preheader8, %for.body
  %i.06 = phi i32 [ %inc, %for.body ], [ %i.06.ph, %for.body.preheader8 ]
  %val.05 = phi i32 [ %mul, %for.body ], [ %val.05.ph, %for.body.preheader8 ]
...
!1 = !DIFile(filename: "D:\\cd_final\\cross-lang-code-detector-master\\testcases\\benchmark\\factorial.c", directory: "D:\\cd_final\\cross-lang-code-detector-master")
